...
if config is not None:
    ...
    def synchronize_data(device_name):
        ...
        if device is not None:
            ...
            try:
                ...
                data_delete_frequency = current_time - timedelta(days=non_written_data_delete_frequency_days)
    ...
    for device in devices:
        device_name = device.get("device_name", "")
        thread = threading.Thread(target=synchronize_data, args=(device_name,))
        thread.daemon = True
        thread.start()
